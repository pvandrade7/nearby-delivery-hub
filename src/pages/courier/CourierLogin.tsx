...
const CourierLogin = () => {
  ...
  const continueFlow = () => {
    ...
    else navigate("/entregador/painel");
  };
    ...
    <div className="px-6 py-10 max-w-md mx-auto">
      ...
      <div className="mt-8">
        ...
        <h1 className="text-2xl font-extrabold">
          {step === "phone" ? "Entrar como Entregador" : "Confirme seu número"}
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          {step === "phone" ? "Entre para aceitar corridas e acompanhar seus ganhos." : `Digite o código enviado por SMS para ${phone || "seu número"}.`}
        </p>
      </div>
      ...
      <div className="mt-8 space-y-4">
        ...
        <button onClick={() => navigate("/entregador/painel")} className="w-full text-sm text-primary font-bold">
